'use client';
import { MATERIALI_COLUMNS, MOVIMENTI_MATERIALE_COLUMNS, PANTONE_COLUMNS } from '@/constants/defaultColumns';
...
export default function Table<T extends BaseItem>({ items = [], config = [], tableKey, rows, filterFn }: TableProps<T>): JSX.Element {
  ...
  const ALL_COLUMNS: TableColumn[] =
    tableKey === 'materiali' ? MATERIALI_COLUMNS : tableKey === 'movimenti-materiale' ? MOVIMENTI_MATERIALE_COLUMNS : PANTONE_COLUMNS;
